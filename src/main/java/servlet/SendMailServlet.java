...
//запрос параметров почтового сервера из web.xml
        ...
        java.util.Properties props = new java.util.Properties(); //загрузка параметров почтового сервера в объект свойств
        props.put(host, hostvalue);
        props.put(port, portvalue);
//загрузка параметров почтового сервера в объект почтовой сессии
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ((from == null) || (to == null)
                || (subject == null) || (content == null)) { /*при отсутствии одного из параметров предлагается повторить
ввод*/
