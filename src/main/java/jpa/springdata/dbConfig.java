...
//@EnableJpaRepositories("jpa.springdata")
//@Configuration
...
//        boneCPDataSource.setJdbcUrl(env.getProperty("database.url"));
//        boneCPDataSource.setUsername(env.getProperty("database.user"));
//        boneCPDataSource.setPassword(env.getProperty("database.password"));
...
//        factory.setPackagesToScan("jpa.springdata");
